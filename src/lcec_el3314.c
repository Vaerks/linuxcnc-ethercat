...
static const lcec_pindesc_t slave_pins[] = {
  { HAL_BIT, HAL_OUT, offsetof(lcec_el3314_chan_t ,error), "%s.%s.%s.ain-%d-error" },
  { HAL_BIT, HAL_OUT, offsetof(lcec_el3314_chan_t, sync_err), "%s.%s.%s.ain-%d-sync-err" },
  { HAL_BIT, HAL_OUT, offsetof(lcec_el3314_chan_t ,overrange), "%s.%s.%s.ain-%d-overrange" },
  { HAL_BIT, HAL_OUT, offsetof(lcec_el3314_chan_t ,underrange), "%s.%s.%s.ain-%d-underrange" },
  { HAL_S32, HAL_OUT, offsetof(lcec_el3314_chan_t ,raw_val), "%s.%s.%s.ain-%d-raw" },
  { HAL_FLOAT, HAL_OUT, offsetof(lcec_el3314_chan_t ,val), "%s.%s.%s.ain-%d-val" },
...
static ec_pdo_entry_info_t lcec_el3314_channel1[] = {
...
static ec_pdo_entry_info_t lcec_el3314_channel2[] = {
...
static ec_pdo_entry_info_t lcec_el3314_channel3[] = {
  ...
  //  {0x6020, 0x10, 1}, /* TxPDO State */
    {0x1802, 0x09, 1},
    {0x6020, 0x11, 16}, /* Value */
};

static ec_pdo_entry_info_t lcec_el3314_channel4[] = {
...
static ec_pdo_info_t lcec_el3314_pdos[] = {
    {0x1a00, 11, lcec_el3314_channel1}, /* TC TxPDO-MapCh.1 */
    {0x1a01, 11, lcec_el3314_channel2}, /* TC TxPDO-MapCh.2 */
    {0x1a02, 11, lcec_el3314_channel3}, /* TC TxPDO-MapCh.3 */
    {0x1a03, 11, lcec_el3314_channel4}, /* TC TxPDO-MapCh.4 */
};
...
static ec_sync_info_t lcec_el3314_syncs[] = {
    ...
    {3, EC_DIR_INPUT, 4, lcec_el3314_pdos + 0, EC_WD_DISABLE},
    {0xff}
};
